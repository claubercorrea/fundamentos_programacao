...
# a. Faça agora o mesmo exercício, entretanto; lendo o reajuste (em %) do usuário.
try:
    print('MENU\n')
    ...
    if(opcao < 1 or opcao >2):
        ...
        if(mercadoria <=0):
            ...
            if(opcao ==1):
                descontoMercadoria = desconto * mercadoria
                soma+=1
                print(f'desconto da mercadoria {descontoMercadoria:.2f}')
            else:
                acrecimoProduto = acrescimo *mercadoria 
                soma+=1
                print(f'acrescimo da mercadoria {acrecimoProduto:.2f}')
